...
public class IncrSSSP {
	...
	public static class SSSPProjector implements Projector<LongWritable, LongWritable, FloatWritable> {
		...
		public FloatWritable initDynamicV(LongWritable dynamickey) {
			try {
				throw new IOException("not possible here");
			} catch (IOException e) {
	...
	private static void printUsage() {
		System.out.println("incrsssp <UpdateStatic> <DeltaStatic> <ConvergedValuePath> <PreservePath> <outDir>");
	...
	public static int main(String[] args) throws Exception {
		...
		String iteration_id = "incrsssp" + new Date().getTime();
	    ...
	    JobConf incrstartjob = new JobConf(IncrSSSP.class);
	    String jobname = "Incr SSSP Start" + new Date().getTime();
	    ...
	    incrstartjob.setIterativeMapperClass(SSSPMap.class);	
	    incrstartjob.setIterativeReducerClass(SSSPReduce.class);
	    incrstartjob.setProjectorClass(SSSPProjector.class);
    	...
    	Util.writeLog("incr.sssp.log", "incremental start computation takes " + incrtime + " s");
	    ...
	    JobConf incriterjob = new JobConf(IncrSSSP.class);
	    jobname = "Incr SSSP Iterative Computation " + iterstart;
	    ...
	    incriterjob.setIterativeMapperClass(SSSPMap.class);	
	    incriterjob.setIterativeReducerClass(SSSPReduce.class);
	    incriterjob.setProjectorClass(SSSPProjector.class);
    	...
    	Util.writeLog("incr.sssp.log", "cachetype "+ cachetype + " iteration computation takes " + itertime + " s");
