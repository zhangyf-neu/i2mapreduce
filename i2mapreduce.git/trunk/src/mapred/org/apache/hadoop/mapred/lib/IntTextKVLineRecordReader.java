...
public class IntTextKVLineRecordReader implements RecordReader<IntWritable, Text> {
	  ...
	  public IntTextKVLineRecordReader(Configuration job, FileSplit split)
	    throws IOException {
	  ...
	  //added by Yanfeng
	  public IntTextKVLineRecordReader(Configuration job, InputStream in)
			    throws IOException {
	  ...
	  public synchronized boolean next(IntWritable key, Text value)
	    throws IOException {
