...
public interface TaskUmbilicalProtocol extends VersionedProtocol {
  ...
  ReduceTaskCompletionEventsUpdate getLocalReduceCompletionEvents(JobID jobId, int iteration) throws IOException;
  MapReduceOutputReadyEvent getMapReduceOutputReadyEvent(JobID jobid, int iteration, int mapperid) throws IOException;
