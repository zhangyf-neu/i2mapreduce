...
public class BufferedRandomAccessFile extends RandomAccessFile {
    ...
    static ResourceBundle res = ResourceBundle.getBundle("org.apache.hadoop.mapred.io.Res");
    ...
    public long getInitfilelen() {
		return initfilelen;
	}

	public void setInitfilelen(long initfilelen) {
		this.initfilelen = initfilelen;
	}
