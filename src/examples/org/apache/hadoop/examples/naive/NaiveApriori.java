...
public class NaiveApriori { 
	...
	public static void main(String[] args) throws IOException { 
        ...
        if(args.length!=5){  
            System.out.println("Usage: <input><output><min_support><last frist result><partitions>");  
            System.exit(1);  
        }  
        String input=args[0];  
...
//        JobConf job1=new JobConf(NaiveApriori.class);   
...
//                 
        ...
        JobConf job2=new JobConf(NaiveApriori.class);   
        ...
        Util.writeLog("comp.apriori.time", "incr.apriori takes time : "+time/1000+" s");
	}
